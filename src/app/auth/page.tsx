...
const cities = ["Coimbatore", "Chennai", "Remote", "Other"];
...
function AuthContent() {
  ...
  // Sync mode with URL param on every navigation
  useEffect(() => {
  ...
  const [studentType, setStudentType] = useState<"student" | "professional">(
    "student",
  );
          ...
          <div className="bg-[#111] border border-white/10 rounded-2xl p-8 md:p-10 shadow-2xl">
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-[#111] px-3 text-gray-500">
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-6 lg:px-16 pt-32 pb-16">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white leading-tight mb-4">
              Begin Your <span className="text-red-500">Cybersecurity</span>{" "}
              Journey
            </h1>
            <p className="text-gray-400 text-base md:text-lg max-w-lg mx-auto leading-relaxed">
              Fill in your details and we&apos;ll get you started on the path to
          ...
          >
            ...
            <div className="bg-[#111] border border-white/10 rounded-2xl p-7">
              ...
              <p className="text-gray-500 text-sm mb-5">
                We keep batch sizes small to ensure personalized attention and
                quality mentorship.
              </p>
