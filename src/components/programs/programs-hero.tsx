...
export function ProgramsHero() {
    return (
        <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center overflow-hidden bg-[#050505] font-sans px-4">
            ...
            <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center mt-20">
                <motion.div
                    ...
                    className="inline-flex items-center gap-2 px-3 py-1 bg-[#1a1a1a] border border-[#262626] rounded-full text-[12px] font-semibold text-[#f2f2f2] uppercase tracking-wider mb-[32px]"
                >
                ...
                <motion.h1
                    ...
                    className="text-[48px] md:text-[64px] lg:text-[76px] font-bold tracking-tight text-[#f2f2f2] leading-[1.1] mb-[24px]"
                >
                    7 Months. 4 Tracks.{" "}
                ...
                <motion.p
                    ...
                    className="text-[16px] md:text-[20px] text-[#a3a3a3] max-w-2xl mx-auto leading-relaxed mb-[64px]"
                >
