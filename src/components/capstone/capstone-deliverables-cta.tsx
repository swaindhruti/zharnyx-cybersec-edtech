    ...
    <section className="bg-[#050505] font-sans py-[120px] px-6 border-t border-[#1a1a1a]">
      <div className="container mx-auto max-w-[1280px]">
        ...
        <div className="max-w-[800px] mx-auto mb-[120px]">
          ...
          >
            Portfolio <span className="text-[#ea384c]">Outputs</span>
          </motion.h2>
          ...
          <div className="space-y-[16px] md:space-y-[24px] max-w-2xl">
            {deliverables.map((item, i) => (
              ...
              >
                <CheckCircle2 className="text-[#ea384c] w-6 h-6 shrink-0" />
        ...
        >
          {/* Subtle Glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-[#ea384c] opacity-[0.1] blur-[80px] pointer-events-none" />

          <div className="relative z-10 flex flex-col items-center">
            <h2 className="text-[32px] md:text-[48px] font-bold text-[#ffffff] leading-[1.1] tracking-tight mb-[24px]">
              Ready for the <span className="text-[#ea384c]">Challenge?</span>
            </h2>
            ...
            <div className="flex justify-center">
              <Link
                href="/enroll"
                className="inline-flex items-center gap-[8px] bg-[#ea384c] text-white px-[32px] py-[16px] rounded-full font-semibold text-[15px] hover:bg-[#d92d3f] transition-colors"
                style={{
